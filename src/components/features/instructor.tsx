            ...
            <div className="relative mb-6">
              ...
              >
                ...
                <div className="text-sm text-gray-600 dark:text-gray-400">
                  {instructor.stats.studentsHelped} students helped
                </div>
              </motion.div>
            </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-green-50 dark:bg-green-900/20 rounded-lg p-4">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="text-sm text-green-600 dark:text-green-400">Experience</span>
                  </div>
                  <div className="text-2xl font-bold text-gray-900 dark:text-white">
                    {instructor.stats.yearsExperience} Years
                  </div>
                </div>
                <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4">
                  <div className="flex items-center gap-2 mb-1">
                    <Users className="w-4 h-4 text-blue-600" />
                    <span className="text-sm text-blue-600 dark:text-blue-400">Students</span>
                  </div>
                  <div className="text-2xl font-bold text-gray-900 dark:text-white">
